...
struct BoundedBuffer {
    ...
    void deposit(int data){
        ...
        // 2nd parameter is a predicate (that is a function that returns a bool).
...
void producer(std::mutex &m, int id, BoundedBuffer& buffer){
    for(int i = 0; i < 15; ++i)
    {
        ...
        std::this_thread::sleep_for(std::chrono::milliseconds(500+rand()%10));
    }
}
...
int main(){
    ...
    // object. std::ref is a helper function for reference_wrapper.    std::mutex m;
